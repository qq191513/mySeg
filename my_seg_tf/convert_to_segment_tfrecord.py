...
##########################要改的东西#######################################
paramenmt_set['src'] = '/home/mo/work/seg_caps/my_seg/dataset/Images'  #源图片集
paramenmt_set['mask'] = '/home/mo/work/seg_caps/my_seg/dataset/Masks_1'  #对应的mask路径
paramenmt_set['dst_folder'] = 'dataset_tf' #存放的目录
