...
from data_process.find_dir import finddir
...
##########################要改的东西#######################################
paramenmt_set['src'] = '/home/mo/work/seg_caps/my_seg_tf/dataset/ckpt_dir/Images'  #源图片集
paramenmt_set['mask'] = '/home/mo/work/seg_caps/my_seg_tf/dataset/ckpt_dir/Masks_1'  #对应的mask路径
paramenmt_set['dst_folder'] = '/home/mo/work/seg_caps/my_seg_tf/dataset/ckpt_dir/dataset_hand_64_64_tf' #存放的目录
paramenmt_set['dst_file'] = 'seg_hand' #生成的文件名前缀

paramenmt_set['_NUM_VALIDATION'] = 100 #测试张数
paramenmt_set['_RANDOM_SEED'] = 33  #随机洗乱种子
paramenmt_set['_NUM_SHARDS'] = 3 #tfrecord分割块数
