...
def plot_roc_curve(y_true,y_scores,save_plot_curve_dir,curve_name):
    ...
    plt.plot(fpr, tpr, '-', label='Area Under the Curve (AUC = %0.4f)' % AUC_ROC,color = 'black')
    plt.title('ROC curve')
...
def plot_precision_recall_curve(y_true, y_scores,save_plot_curve,curve_name):
    ...
    plt.plot(recall, precision, '-', label='Area Under the Curve (AUC = %0.4f)' % AUC_prec_rec,color = 'red')
