...
def my_segcap(images,is_train,size, l2_reg):
    ...
    # 1/2  (64 -> 128)
    multiple = 1
    u_cap3_1 = capsule(u_cap2_3, "deconv", k=3, s=2, t=start_s*multiple, z=atom, routing=3)
    ...
    cap_out_5 =conv(cap_out_4, filters=256, kernel_size=[1,1],l2_reg_scale=l2_reg, batchnorm_istraining=is_training)
