...
def my_segcap(images,is_train,size, l2_reg):
    ...
    # 1/2  (128 -> 64)
    multiple = 1
    cap1_1 = capsule(conv_prime, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=3,bn=True)
    cap1_2 = residual_cap_block(cap1_1,routing=3)
    # cap1_1 = print_tensor(cap1_1,'cap1_1')
    cap1_3 = capsule(cap1_2, "conv", k=3, s=2, t=start_s*multiple, z=8, routing=3,bn=True)
    # cap1_2 = print_tensor(cap1_2,'cap1_2')
    skip1 = cap1_2

    # 1/4  (64 -> 32)
    multiple = 2
    cap2_1 = capsule(cap1_3, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=3,bn=True)
    cap2_2 = residual_cap_block(cap2_1,routing=3)
    # cap2_1 = print_tensor(cap2_1,'cap2_1')
    cap2_3 = capsule(cap2_2, "conv", k=3, s=2, t=start_s*multiple, z=8, routing=3,bn=True)
    ...
    # 1/8  (32 -> 16)
    multiple = 4
    cap3_1 = capsule(cap2_3, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=3,bn=True)
    cap3_2 = residual_cap_block(cap3_1,routing=3,batchnorm_istraining=True)
    cap3_3 = capsule(cap3_2, "conv", k=3, s=2, t=start_s*multiple, z=8, routing=3,bn=True)
    skip3 = cap3_2
    ...
    # cap_m_2 = capsule(cap3_2,"conv", k=3, s=1, t=start_s*multiple, z=8, routing=2)
    ...
    # 1/8  (16 -> 32)
    multiple = 4
    u_cap1_1 = capsule(cap_m_2, "deconv", k=3, s=2, t=start_s*multiple, z=8, routing=3,bn=True)
    u_cap_concat_1 = tf.concat([u_cap1_1, skip3], axis=3)
    # u_cap1_2 = capsule(u_cap_concat_1, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=2)
    # u_cap1_3 = capsule(u_cap1_2, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=2)
    u_cap1_2 = residual_cap_block(u_cap_concat_1,routing=3,batchnorm_istraining=True)

    # 1/4  (32 -> 64)
    multiple = 2
    u_cap2_1 = capsule(u_cap1_2, "deconv", k=3, s=2, t=start_s*multiple, z=8, routing=3,bn=True)
    ...
    # 1/2  (64 -> 128)
    multiple = 1
    u_cap3_1 = capsule(u_cap2_3, "deconv", k=3, s=2, t=start_s*multiple, z=8, routing=3,bn=True)
    ...
    # u_cap3_2 = capsule(u_cap_concat_3, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=2,bn=True)
    u_cap3_2 = residual_cap_block(u_cap_concat_3,routing=3)
    # u_cap3_2 = print_tensor(u_cap3_2,'u_cap3_2')

    # 1   (128 -> 128)
    # cap_out_1 = capsule(u_cap3_2, "conv", k=3, s=1, t=start_s*multiple, z=8, routing=2,bn=True)
