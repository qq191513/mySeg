...
def my_segcap(images,is_train,size, l2_reg):
    ...
    cap1_1 = residual_cap_block(conv_prime,routing=2)
    # cap1_1 = print_tensor(cap1_1,'cap1_1')
    cap1_2 = capsule(cap1_1, "conv", k=3, s=2, t=start_s*multiple, z=8, routing=2)
    ...
    cap2_1 = residual_cap_block(cap1_2,routing=2)
    # cap2_1 = print_tensor(cap2_1,'cap2_1')
    cap2_2 = capsule(cap2_1, "conv", k=3, s=2, t=start_s*multiple, z=8, routing=2)
    ...
    cap_m_1 = residual_cap_block(cap2_2,routing=2)
    # cap_m_1 = print_tensor(cap_m_1,'cap_m_1')
    cap_m_2 = residual_cap_block(cap_m_1,routing=2)
    ...
    # 1/4  (32 -> 64)
    multiple = 2
    u_cap2_1 = capsule(cap_m_2, "deconv", k=3, s=2, t=start_s*multiple, z=8, routing=3)
    ...
    # 1/2  (64 -> 128)
    multiple = 1
    u_cap3_1 = capsule(u_cap2_3, "deconv", k=3, s=2, t=start_s*multiple, z=8, routing=3)
