...
##########################   训练集相关   #######################################
#训练数据集
train_images = "/home/mo/work/seg_caps/my_seg_keras/dataset/ckpt_dir/Images/"
train_label = "/home/mo/work/seg_caps/my_seg_keras/dataset/ckpt_dir/Masks_1/"
...
##########################   训练配置   ########################################
#模型选择
load_model =UNet(input_shape)

#保存模型路径
save_weights_path= '/home/mo/work/seg_caps/my_seg_keras/weights/hand_64_64_unet'
#epochs是训练总次数
epochs =50
