...
pre_color_pics_path = os.path.join(cfg.project_root,'output_predict_result/segcap_hand_64_64/pre_color_pics')
vstack_pics = False
hstack_pics = True
show_size = (512,512)
########################        end      ########################################
...
def show_dataset( images_path , segs_path , pre_color_pics_path, n_classes ):
    ...
    segmentations.sort()
    pre = glob.glob(os.path.join(pre_color_pics_path, "*.jpg"))+ glob.glob(os.path.join(pre_color_pics_path, "*.png")) + glob.glob(os.path.join(pre_color_pics_path, "*.jpeg"))
    pre.sort()
...
show_dataset(images_path , label_path , pre_color_pics_path, cfg.n_classes)
