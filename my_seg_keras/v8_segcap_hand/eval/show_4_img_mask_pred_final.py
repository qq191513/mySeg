...
pre_color_pics_path = os.path.join(cfg.project_root,
        'output_predict_result/segcap_hand_64_64/pre_color_pics')
pre_class_pics_path = os.path.join(cfg.project_root,
        'output_predict_result/segcap_hand_64_64/pre_class_pics')
...
def show_dataset( images_path , segs_path , pre_color_pics_path,pre_class_pics_path, n_classes ):
    ...
    segmentations.sort()
    pre_color = glob.glob(os.path.join(pre_color_pics_path, "*.jpg"))+ glob.glob(os.path.join(pre_color_pics_path, "*.png")) + glob.glob(os.path.join(pre_color_pics_path, "*.jpeg"))
    pre_color.sort()
    pre_class = glob.glob(os.path.join(pre_class_pics_path, "*.jpg"))+ glob.glob(os.path.join(pre_class_pics_path, "*.png")) + glob.glob(os.path.join(pre_class_pics_path, "*.jpeg"))
    pre_class.sort()
...
show_dataset(images_path , label_path , pre_color_pics_path,pre_class_pics_path, cfg.n_classes)
