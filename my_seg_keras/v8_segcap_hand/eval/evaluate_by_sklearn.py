...
#图片保存路径
save_pic_dir = os.path.join(eval_output_path, 'pre_color_pics')
os.makedirs(save_pic_dir, exist_ok=True)
#csv保存路径
save_csv_dir = os.path.join(eval_output_path, 'test_csv')
os.makedirs(save_csv_dir, exist_ok=True)
save_list_csv = os.path.join(save_csv_dir,'test.csv')
save_mean_csv = os.path.join(save_csv_dir,'test_mean.csv')
